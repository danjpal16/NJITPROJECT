...
function swapPhoto () {
  ...
  $('.name').text("Name: " + imageData.imgName);
  $('.rank').text("Rank: " + imageData.imgRank);
  $('.rating').text("Rating: " + imageData.imgRating);
  $('.airtime').text("Air Time: " + imageData.imgAirtime);
  $('.description').text("Description: " + imageData.imgDescription);
}
